...
const SECTIONS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body:
      "قبل حجزك الأول نطلب رقم هويتك أو إقامتك وصورة منها، وصورة من رخصة القيادة — لأن الفرع ملزم بالتحقق من هوية المستأجر وأهليته للقيادة قبل تسليم السيارة. تُحفظ الصور في مساحة خاصة لا يصل إليها أي عميل آخر، ويطّلع عليها فريق العمل والفرع المعني فقط لغرض التحقق. وقد تُعرض الصورة على نظام آلي للتأكد المبدئي من أنها المستند المطلوب قبل قبول الحجز.",
  },
  {
    title: "بيانات الدفع",
    body:
