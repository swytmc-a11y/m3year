...
> طلب التوثيق المالي ومتابعة حالته. **تدفق المحاسب والإدارة يبقى على تطبيق
> الويب** (قرار تصميم: العمليات التشغيلية على الويب، تجربة المستهلك على
> الجوال). بقية الوحدات (الرسائل، التقييمات...) تُبنى تباعًا.
